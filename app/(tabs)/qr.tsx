...
//   const [scannedData, setScannedData] = useState("no data");
//   const [scanningSuccess, setScanningSuccess] = useState(false);
//   const [scanningFailure, setScanningFailure] = useState(false);
...
//         setScannedData("no data");
//       }, 2000);
//     } else if (scanningFailure) {
//       playFailureSound();
//       setTimeout(() => {
//         setScanningFailure(false);
//         setScannedData("no data");
//       }, 2000);
//     }
//   }, [scanningSuccess, scanningFailure]);
...
//   const retrieveScan = (scannedResult: BarcodeScanningResult) => {
//     const data = scannedResult?.data || "no result";
//     if (data.length < 10) {
//       setScanningSuccess(true);
//     } else {
//       setScanningFailure(true);
//     }
//     setScannedData(data);
//   };
...
//     inputRange: [0, 1],
//     outputRange: [0, 100], // value for translateY
//   });
